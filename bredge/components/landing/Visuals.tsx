  ...
  return (
    <div className="reference-work" ref={stageRef}>
      <div className="reference-sticky">
        <article className="reference-case"><div className="case-copy"><span>WORK 01</span><h3>SaaS Growth Dashboard</h3><p>Activation, retention and churn risk, in the form product and growth teams ask for it every Monday.</p><small>Product analytics · Cohorts · Retention · Customer health · BI pattern</small><a className="text-link" href="/schedule">Walk through this build on a call <span aria-hidden="true" className="arrow">↗</span></a></div><SaaSDashboard /></article>
        <article className="reference-case cfo-case"><div className="case-copy"><span>WORK 02</span><h3>CFO Dashboard</h3><p>Where the cash is, who owes you, and what needs chasing today.</p><small>Cash flow · AR / DSO · Profitability · Variance · Forecasting</small><a className="text-link" href="/schedule">Walk through this build on a call <span aria-hidden="true" className="arrow">↗</span></a></div><CFODashboard /></article>
        <article className="reference-case pipeline-case"><div className="case-copy"><span>WORK 03</span><h3>Five Systems, One Customer Count</h3><p>The identity resolution, reconciliation and tests that happen before any of this reaches a chart.</p><small>Python · SQL · PostgreSQL · Reconciliation · Governance</small><a className="text-link" href="/schedule">Walk through this build on a call <span aria-hidden="true" className="arrow">↗</span></a></div><PipelineDemo /></article>
      </div>
    </div>
  );
}
