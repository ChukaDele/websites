...
export const metadata: Metadata = {
  ...
  keywords: ["data engineering", "data analytics", "business intelligence", "BI consulting", "Power BI", "reporting automation", "data quality", "data governance", "data operations", "embedded data team", "fractional data team", "data reconciliation", "AI-ready data foundations"],
